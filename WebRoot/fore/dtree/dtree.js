...
function dTree(objName) {
	...
	this.icon = {
		root				: 'dtree/img/empty.gif',		root2				: 'dtree/img/base.gif',
...
dTree.prototype.toString = function() {
	var str = '<div class="dtree" style="margin-top:-15px;">\n';
...
dTree.prototype.node = function(node, nodeId) {
	...
	if (this.config.useIcons) {
		...
		}		/*哥配置的*/		if(node.id==60||node.id==61){			node.icon = this.icon.root2;		}
