...
<html>
<head>
<title>Civil Engineer  A industrial category Flat bootstrap Responsive  Website Template | Single :: w3layouts</title>
  ...
  <div class="header">
	<div class="container">
		 <div class="header-main">
				<div class="logo">
					<h1><a href="index.html">songhu</a></h1>
				</div>
				<div class="top-nav">
				 ...
				 <nav class="cl-effect-1">
					<ul class="res">
					   ...
					   <li><a class="active" href="about.html">公司简介</a></li> 
						<li><a href="services.html">核心业务</a></li> 
						<li><a href="gallery.html">经典案例</a></li> 
						<li><a href="shortcords.html">发展规划</a></li> 
